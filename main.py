...
def show_flights():
    try:
        ...
        second_window.iconbitmap('img/planeicon.ico')
        frame1 = ttk.Frame(second_window)
        frame1.grid()
        bg2_image = PhotoImage(file='img/bg10_.png')
...
mainwindow.iconbitmap('img/planeicon.ico')
frame0.pack()
bg_image = PhotoImage(file='img/bg2.png')
